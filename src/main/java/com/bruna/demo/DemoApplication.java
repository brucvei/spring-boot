...
import com.bruna.demo.repositories.*;
...
public class DemoApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Pagamento pagto1 = new Cartao(null, StatusPagamento.QUITADO, ped1, 6);
		Pagamento pagto2 = new Boleto(null, StatusPagamento.PENDENTE, ped2, sdf.parse("20/10/2017 00:00"), null);
